...
export class OrdersComponent extends RealtimeGridComponent<IOrder, IOrderParams> {
  ...
  readonly headers: HeaderItem<OrderColumn>[] = [
    ...
    { name: OrderColumn.accountId, title: 'ACCOUNT' },
    OrderColumn.symbol,
    OrderColumn.exchange,
    OrderColumn.description,
    OrderColumn.side,
    OrderColumn.type,
    { name: OrderColumn.quantity, title: 'QTY' },
    { name: OrderColumn.filledQuantity, title: 'QTY FILLED' },
    { name: OrderColumn.quantityRemain, title: 'QTY REMAIN' },
    { name: OrderColumn.averageFillPrice, title: 'Average Fill Price' },
    { name: OrderColumn.duration, title: 'tif' },
    OrderColumn.status,
    // OrderColumn.fcmId,
    // OrderColumn.ibId,
    { name: OrderColumn.identifier, title: 'ORDER ID' },
    // OrderColumn.close,
  ];
