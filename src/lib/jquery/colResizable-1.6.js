/**
 ...
 This is modified version. If you need use newest version please add listener on layout-resize.
 */
...
(function ($) {
  ...
  var memento = function (t, th) {
    ...
    if (th) {										//in deserialization mode (after a postback)
      ...
      S[t.id] += m;							//the last item of the serialized string is the table's isActive area (width),
  ...
  var onGripDrag = function (e) {
    ...
    var mw = t.opt.minWidth, i = drag.i;	//cells's min width
      ...
      for (var t in tables) {
        if (tables.hasOwnProperty(t)) {
          ...
          if (t.f) {                  //in fixed mode
            ...
            //cells rendering is not as trivial as it might seem, and it is slightly different for
  ...
  $(window).bind('layout-resize.' + SIGNATURE, onResize);
