...
declare namespace GoldenLayout {
  ...
  export interface Settings {
     ...
     * be transferred to the new window, if false only the isActive component will be opened.
     * Default: false
     */
  ...
  export interface ContentItem extends EventEmitter {
     ...
     * @param keepChild If true the item won't be destroyed. (Use cautiosly, if the item isn't destroyed it's up to you to destroy it
     * later). Default: false.
     */
     ...
     * Useful e.g. for indicating state changes.
     */
     ...
     * @param contentItem The new isActive content item
     */
  ...
  export interface Tab {
    ...
    /**
     * Sets this tab's isActive state. To programmatically switch tabs, use header.setActiveContentItem( item ) instead.
     * @param isActive Whether the tab is isActive
     */
